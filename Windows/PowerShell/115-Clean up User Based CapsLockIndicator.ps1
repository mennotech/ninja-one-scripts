...
.DESCRIPTION
    ...
    Loads user registry hives for offline profiles to remove startup entries.
.OUTPUTS
    Informational messages written to the host summarizing what was found and removed.
.NOTES

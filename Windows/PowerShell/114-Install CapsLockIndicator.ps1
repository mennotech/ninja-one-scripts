...
.DESCRIPTION
    Downloads latest CapsLockIndicator, installs to Program Data, registers for all users startup,
    and applies custom configuration from a NinjaOne custom field named 'capsLockIndicatorConfiguration'.
.OUTPUTS
    Informational messages are written to the host indicating each step of the deployment process.
.NOTES
